...
<br>
    ...
    <form method="post" action="welcome.jsp?course_id=${ctx.courseId.externalString}"> 
	<input type="submit" name="button" id="ActivateLab4" value="ActivateLab4"  />
	</form>
...
<br>
	...
	<form method="post" action="welcome.jsp?course_id=${ctx.courseId.externalString}"> 
	<input type="submit" name="button" id="ActivateLab5" value="ActivateLab5"  />
	</form>
...
<br>
    ...
    <form method="post" action="welcome.jsp?course_id=${ctx.courseId.externalString}"> 
	<input type="submit" name="button" id="ActivateLab7" value="ActivateLab7"  />
	</form>
...
<br>
	...
	<form method="post" action="welcome.jsp?course_id=${ctx.courseId.externalString}"> 
	<input type="submit" name="button" id="ActivateLab8" value="ActivateLab8"  />
	</form>
...
<br>
	...
	<form method="post" action="welcome.jsp?course_id=${ctx.courseId.externalString}"> 
	<input type="submit" name="button" id="ActivateLab9" value="ActivateLab3=9"  />
	</form>
